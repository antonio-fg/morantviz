...
dicc <- tibble::tribble(~codigo, ~pregunta,~respuestas,
...
g$
  contar_variables(variables="efectivo",confint = F)$
  pegar_diccionario()$
  pegar_color()$
  calcular_pct()$
  graficar_barras_h(x = "respuesta", 
                    y = "pct") +
...
op <- g$
  ...
  graficar_barras_divergente(x = "nombre",
                              regular = "Regular",
...
op <- g$
  ...
  graficar_barras_divergente(regular = NULL,
                                  positivas = c("Buena", "Muy buena"),
                                  negativas = c("Mala", "Muy mala"), 
                                  caption = T,
                                  ancho_cap = 25,
...
### Diccionario de problemas
dicc <- tibble::tribble(~codigo, ~nombre, ~pregunta,~respuestas,
...
g$
  ...
  pegar_color()$
  calcular_pct()$
  barras_apiladas(x = "nombre",caption = T,
                                ancho_cap = 20,
                                ancho_etiquetas = 5)
