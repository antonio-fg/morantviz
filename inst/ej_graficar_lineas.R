...
## Lista de categorias 
categorias <- c( "Baches en calles y avenidas",
  "Delincuencia",
  "Falta de agua",
  "Falta de alumbrado",
...
g <- Graficar$new(bd = bd_respuestas,
                        diccionario = dicc,
                        colores = colores,
...
g$
  ...
  pegar_diccionario()$
  calcular_pct()$
  pegar_colorPorGrupo("nombre")$
  filtrar_respuesta(valor = c("Baches en calles y avenidas", "Falta de agua", "Falta de recolección de basura"))$
...
bd_aprob_rosario_2024  <- problemas(cat = categorias,llave = "aprob_rosario",n = 100) |> mutate(año = 2024)
bd_aprob_rosario_2025  <- problemas(cat = categorias,llave = "aprob_rosario",n = 100) |> mutate(año = 2025)
bd_aprob_rosario_2026  <- problemas(cat = categorias,llave = "aprob_rosario",n = 100) |> mutate(año = 2026)


## binding de las respuestas por año 
bd_total_rosario <- bind_rows(bd_aprob_rosario_2024, bd_aprob_rosario_2025, bd_aprob_rosario_2026) |>
...
### Diccionario 
dicc <- tibble::tribble(~codigo, ~pregunta,
...
g <- Graficar$new(bd = bd_total_rosario,
                        diccionario = dicc,
                        colores = colores,
                        color_principal = "#340e63",
                        tema = tema_morant())
...
graficar_lineas(x ="año", 
                  ...
                  grupo = "respuesta", 
                  letra_tam = 7, 
                  rango_offset = 0.00) + facet_wrap(~respuesta)
