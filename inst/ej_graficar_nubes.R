...
dicc <- tibble(
  ...
  pregunta = rep("¿Cuál es la problemática más frecuente que enfrenta usted en sus funciones?", 54)
)



g <- Graficar$new(bd = bd,
                  diccionario = dicc,
                  colores = colores,
...
g$procesar_nubes("j_problemaJefe")$
  graficar_nube(n=2, gradiente = c(bajo = "#ca4992", alto = "#5B1AA4"))

g$contar_variable_multirespuesta(variable = paste("categoria", "j_problemaJefe", sep = "_"),
    sep = ">>>",
    confint = F)
