...
g <- Graficar$new(bd = bd_redes_soc,
                        diccionario = dicc,
                        colores = colores,
...
g$
  contar_variables(variables="redes_soc",confint = F)$
  pegar_diccionario()$
  extraer_respuestas(codigo = "redes_soc")$   #Se recomienda poner este método después de pegar diccionario 
  pegar_color()$
  calcular_pct()$
  graficar_barras_h(x = "respuesta", y = "pct") +

g$
  contar_variables(variables="redes_soc",confint = F)$
  pegar_diccionario()$
  extraer_respuestas(codigo = "redes_soc")$   
  pegar_color()$
  calcular_pct()$
