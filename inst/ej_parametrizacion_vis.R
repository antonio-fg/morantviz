...
pegar_color()$
graficar_barras_v(x = "respuesta",letra_tam = 5, vjust = -.1) + labs(title = "Tamaño predefinido") +

g$contar_variables(variables = "opinion_pm_astiazaran", confint = T)$
pegar_color()$
graficar_barras_v(x = "respuesta",letra_tam=10, vjust = -10 ) +  labs(title = "Nueva paremetrización") 
...
g$contar_variables(variables = c( "opinion_pm_delrio"), confint = F)$
  pegar_diccionario()$
  pegar_color()$
  graficar_lollipops("respuesta", letra_tam = 6, hjust = -0.5, bola_tam = 5) + labs(title = "Tamaño predefinido") +

g$contar_variables(variables = c( "opinion_pm_delrio"), confint = F)$
  pegar_diccionario()$
  pegar_color()$
  graficar_lollipops("respuesta", letra_tam = 10,  hjust = -2, bola_tam = 9) + labs(title = "Nueva parametrización")
...
pegar_diccionario()$
pegar_color()$
graficar_gauge(letra_tam = 12) + labs(title = "Tamaño predeterminado") +
  
 ## Valores predeterminados 
g$contar_variables(variables = "conoce_pm_javier", confint = T)$
pegar_diccionario()$
pegar_color()$
graficar_gauge(letra_tam = 20) + labs(title = "Nueva parametrización")  
...
g$
  ...
  graficar_barras_divergente(regular = "Regular",
                                   positivas = c("Buena", "Muy buena"),
                                   negativas = c("Mala", "Muy mala"),letra_tam = 25, vjust = .5) + labs(title = "Tamaño predeterminado") +
 ...
 g$
  ...
  graficar_barras_divergente(regular = "Regular",
                                   positivas = c("Buena", "Muy buena"),
                                   negativas = c("Mala", "Muy mala"),letra_tam = 40, vjust = .96) + labs(title = "Nueva parametrización") 


################################### Bloques (parametrización) ###################################

g$
  contar_variables_porGrupos(variables = c("identificacion_partido"),grupos = c("sexo"), confint = F)$
  pegar_color()$
  envolver_etiquetas(columna = "respuesta", 10)$
  pegar_diccionario()$
  graficar_bloque(freq = "media" , letra_tam = 2) +
...
g$
  ...
  envolver_etiquetas(columna = "respuesta", 10)$
  pegar_diccionario()$
  graficar_bloque(freq = "media", letra_tam = 20) +
...
g$graficar_piramide(
      ...
      tam_texto_rango_edad = 6) + labs(title = "Tamaño predeterminado") +
...
g$graficar_piramide(
      ...
      espaciado = c(0.05,0.05),
      tam_texto_rango_edad = 12) + labs(title = "Nueva parametrización")
...
g$
  ...
  pegar_diccionario()$
  pegar_color()$
  graficar_lineas(x ="respuesta", letra_tam = 5,hjust =  -.1, vjust = -1, bola_tam = 3) + 
  labs(title = "Tamaño predeterminado") +
 ...
 g$
  ...
  pegar_diccionario()$
  pegar_color()$
  graficar_lineas(x ="respuesta", letra_tam = 10, hjust =  -.4, vjust = -4,bola_tam = 6) + 
  labs(title = "Nueva parametrización")
...
g$
  ...
  confint = F)$
  pegar_diccionario()$  
  graficar_sankey(grupo, letra_tam = 3.5) + labs(title = "Valores predeteminados") + 
...
g$
  ...
  confint = F)$
  pegar_diccionario()$  
  graficar_sankey(grupo,letra_tam = 13.5) + labs(title = "Nueva parametrización")
